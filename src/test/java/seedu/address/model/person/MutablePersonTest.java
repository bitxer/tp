...
public class MutablePersonTest {
    ...
    public void setup() {
        mutablePerson = new MutablePerson(new Name(VALID_NAME_AMY), new Phone(VALID_PHONE_AMY),
                new Email(VALID_EMAIL_AMY), new Address(VALID_ADDRESS_AMY), new HashSet<>());
    }
    ...
    public void testSetAllFields() {
        ...
        mutablePerson.setAddress(new Address(VALID_ADDRESS_BOB));
        ...
        assertEquals(VALID_ADDRESS_BOB, mutablePerson.getAddress().toString());
