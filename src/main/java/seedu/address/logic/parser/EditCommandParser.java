...
public class EditCommandParser implements Parser<EditCommand> {
     ...
     */
    private Optional<Set<AbstractTag>> parseTagsForEdit(Collection<String> tags) throws ParseException {
        assert tags != null;
